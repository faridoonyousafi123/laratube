        ...
        <channel-uploads :channel="{{$channel}}" inline-template>
                <div class="col-md-8 ">
                    <div class="card p-3 d-flex justify-content-center align-items-center" v-if="!selected">
                            ...
                            <svg onclick="document.getElementById('video-files').click()" height="70px" width="70px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 548.176 548.176" style="enable-background:new 0 0 548.176 548.176;" xml:space="preserve"><g><g>
                            ...
                            <input type="file" multiple ref="vidoes" id="video-files" style="display:none; cursor:pointer;" @change="upload()">
                    </div>

                    <div class="card p-3" v-else>

                        <div class="my-4" v-for="video in vidoes">
